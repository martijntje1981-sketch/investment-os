...
export const whichInvestmentsSupportedFaq: SupportedInstrumentsFaqEntry = {
  ...
  answer:
    "Investment OS supports live pricing for many listed European and US stocks, ETFs and ETCs, as well as selected major cryptocurrencies. Availability depends on the exchange, listing, trading pair and market-data provider. Holdings that are not currently supported can still be saved, but live prices, performance and portfolio valuation may be unavailable.",
  link: {
...
export const unsupportedInvestmentFaq: SupportedInstrumentsFaqEntry = {
  ...
  answer:
    "You can still save the holding. Investment OS will clearly show when live pricing is unavailable or when the instrument needs review. We continue to expand instrument and crypto support over time.",
};
