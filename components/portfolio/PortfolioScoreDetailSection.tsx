      ...
      <div className={`${appCardPaddingClass} space-y-4`}>
        ...
        {context ? (
          <div className="rounded-xl bg-slate-50 px-3 py-3">
            ...
            <Link
              href={context.href}
              className="mt-3 inline-flex min-h-[44px] items-center text-[13px] font-semibold text-q1-strong underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
            >
              {context.linkLabel}
            </Link>
          </div>
