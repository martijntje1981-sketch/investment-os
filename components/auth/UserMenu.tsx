    ...
    <div className="fixed right-5 top-5 z-[60] sm:right-8">
      <div ref={containerRef} className="relative">
        <button
          ...
          onClick={toggle}
          className="flex cursor-pointer list-none items-center gap-3 rounded-2xl border border-slate-200 bg-white/95 px-3 py-2 shadow-lg backdrop-blur transition hover:bg-slate-50"
        >
        ...
        {open ? (
          <div
            ...
            role="menu"
            aria-label="Profile"
            className="absolute right-0 mt-2 w-72 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl"
          >
